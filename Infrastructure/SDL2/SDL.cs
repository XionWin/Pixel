...
namespace SDL2
{
	...
	{
		public unsafe struct SDL_Window_Handle
		{
			...
			public SDL_Window_Handle* prev; // SDL_Window*
			public SDL_Window_Handle* next; // SDL_Window*
		}
		...
		public static bool SDL_MUSTLOCK(IntPtr surface) =>
			Marshal.PtrToStructure(
				surface,
				typeof(SDL_Surface)
			) is SDL_Surface sur && (sur.flags & SDL_RLEACCEL) != 0;
